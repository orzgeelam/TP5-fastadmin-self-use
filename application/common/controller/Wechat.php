...
class Wechat extends Controller
{
	...
	public function _initialize()
	{
		...
		$this->assign('wechatShare1', json_encode($this->set_share()));
	...
	protected function set_jsapi()
	{
		if ($this->platform == 'weixin') {
			// 分享配置
			$jsapi_config = ['onMenuShareAppMessage', 'onMenuShareTimeline', 'previewImage', 'chooseImage', 'uploadImage', 'chooseWXPay',];
